...
setup(
    ...
    description='A command line tool for modelling gene expression using '+ 
        'genetic variants and covariates',
    url='https://github.com/adamd3/VarPredict',
    packages=['VarPredict'],
    python_requires='>=3.7.0',
    install_requires=['matplotlib', 'numpy', 'pandas', 'scikit-learn'],
